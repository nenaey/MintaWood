...
Public Class CrystalReportItems
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MintaWood.CrystalReportItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportItems
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportItems = New CrystalReportItems()
        rpt.Site = Me.Site
        Return rpt
    End Function
